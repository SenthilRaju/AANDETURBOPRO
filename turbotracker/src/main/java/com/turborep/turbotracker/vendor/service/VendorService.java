...
/*						Prmaster thePrmaster =jobService.getPrMasterBasedOnId(rbVebilldetail.getPrMasterId());
	...
	public Integer insertVebillHistory(Integer veBillid, Integer vepoID,Integer userID) throws VendorException
	{
		...
		try {
			...
			/*SELECT veBillID,vePODetailID,QuantityBilled AS QuantityInvoiced,ROUND (QuantityBilled*UnitCost*PriceMultiplier,4) AS QuantityBilled 
			FROM veBillDetail WHERE veBillID=132837 AND vePODetailID IS NOT NULL */
