...
//		String str = null;
	...
	public BigDecimal getLastYearSale(Integer rxMasterID) throws CustomerException {
		...
		public void copyAllinvoicesfromclg (Integer receiptID,Session aSession)throws CustomerException
		{
			...
			aSession.createSQLQuery("INSERT INTO cuReversePaymentsInv (SELECT null,cuLinkageDetail.* FROM cuLinkageDetail WHERE cuReceiptID ="+receiptID+")").executeUpdate();
		...
		public void deleteAllInvoicesfromclg(Integer receiptID,Session aSession)throws CustomerException
		{
			try
			{
				aSession.createSQLQuery("DELETE cul,cgl FROM cuLinkageDetail cul,cuPaymentGlpost cgl WHERE cul.cuLinkageDetailID = cgl.cuLinkageDetailID AND cul.cuReceiptID = "+receiptID).executeUpdate();
