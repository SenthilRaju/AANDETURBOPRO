...
//			theView.addObject("alRxaddress",alRxaddress);
	...
	public @ResponseBody  ArrayList<Sysvariable> saveJobSettingsSysVariable(
			...
			@RequestParam(value = "ckhIncludeJobInShipToAddressOnPDFYN",required=false) Integer ckhIncludeJobInShipToAddressOnPDFYN ,
			@RequestParam(value = "chkfontStyleonTextEditorYN",required=false) Integer chkfontStyleonTextEditorYN,
			@RequestParam(value = "fontStyleonTextEdValue",required=false) String fontStyleonTextEdValue,
			
			@RequestParam(value = "chkfontSizeonTextEditorYN",required=false) Integer chkfontSizeonTextEditorYN,
			@RequestParam(value = "fontSizeonTextEdValue",required=false) String fontSizeonTextEdValue,
...
//			asysvariable.add(thesysvariable);
			...
			//added By prasant kumar #BID 517 date 20/06/2016
			thesysvariable = new Sysvariable();
			thesysvariable.setValueLong(ckhIncludeJobInShipToAddressOnPDFYN);
			thesysvariable.setSysVariableId(InventoryConstant.getConstantSysvariableId("IncludJobNamein_co_inshiptoaddressonPDForder"));
			asysvariable.add(thesysvariable);
			...
			thesysvariable = new Sysvariable();
			thesysvariable.setValueLong(chkfontStyleonTextEditorYN);
			thesysvariable.setSysVariableId(InventoryConstant.getConstantSysvariableId("QuotechkfontStyleonTextEditorYN"));
			thesysvariable.setValueString(fontStyleonTextEdValue);
			asysvariable.add(thesysvariable);
			
			
			thesysvariable = new Sysvariable();
			thesysvariable.setValueLong(chkfontSizeonTextEditorYN);
			thesysvariable.setSysVariableId(InventoryConstant.getConstantSysvariableId("QuotechkfontSizeonTextEditorYN"));
			thesysvariable.setValueString(fontSizeonTextEdValue);
			asysvariable.add(thesysvariable);
