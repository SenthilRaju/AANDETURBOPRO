...
<table  style="width: 750px;">
	<tr>
		...
		<td align="right" style="padding-left: 382px;">
			<div id="ShowInfoAck" style="width: 380px;height:20px;color: green;"></div>
			<input type="button" id="POReleaseAckSaveButton" class="savehoverbutton turbo-tan IsButtonClicked" value="Save" onclick="SaveAcknowledgementPO()" style="width:90px;" >
		<input type="button" class="savehoverbutton turbo-tan" value="Close" onclick="closePurchaseOrderAckTab()" style="width:120px" >
		</td>
	</tr>
</table>
</div>
