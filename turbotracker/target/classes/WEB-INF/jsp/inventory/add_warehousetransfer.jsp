					...
					<fieldset class= "ui-widget-content ui-corner-all" style="height: 90px;width: 340px;">
								...
								<table style="width: 400px">
									...
									<td style="width: 120px;"><label>Transfer Date<span style="color: red;">*</span>:</label></td>
										<td><input type="text" class="datepicker" id="transferDateId"  readonly="readonly"name="transferDateId" value="<fmt:formatDate pattern="MM/dd/yyyy" value="${currentDate}" />" style="width: 140px;"></td>
									<!-- </tr>							
								</table>
							</fieldset> -->
					</td>
