...
.ui-autocomplete-w1 {
	background: url(./../resources/scripts/jquery-autocomplete/shadow.png)
...
.ui-autocomplete-loading {
	background: white
		url('./../resources/scripts/jquery-autocomplete/loading3.gif') right
		center no-repeat;
}
...
<div id="customertab">
	<form action="" id="customerRolodexForm">
		<table>
			<tr height="5px;"></tr>
			<tr>
				<td width="115px;" style="padding-bottom: 10px;"><label>Customer
						Name: </label></td>
				<td width="" style="padding-bottom: 10px;"><input type="text"
					name="cuStomerName" size="32" id="customerNameHeader" /></td>
				<td align="right" style=""><input type="button"
					class="savehoverbutton turbo-blue" value="Save" id="mainsave"
					onclick="CustomerForm_save()" style=""></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="vertical-align: top; padding-left: 4px;">
					<fieldset style="width: 450px"
						...
						<legend>
							<label><b>Customer Account #</b></label>
						</legend>
						<table>
							<tr>
								<td><input type="text" name="custAccountNumber"
									value="${requestScope.customerMasterObj.accountNumber}"
									id="customer_accountName"></td>
								<td><input type="checkbox" name="custFinanceCharge"
									id="financeCharge" value="1" onclick="financeValue()"><label>Finance
										Charge</label></td>
								<td><input type="checkbox" name="custFinStatement"
									id="statementId" value="1" onclick="statementValue()"><label>Statement</label></td>
							</tr>
						</table>
					</fieldset>
				</td>
				...
				<td style="vertical-align: top; padding-left: 4px;">
					<fieldset
						style="width: 483px; margin-left: -131px; overflow-y: auto; height: 93px;"
						class=" ui-widget-content ui-corner-all">
						<legend>
							<label><b>Tax Territories </b></label>
						</legend>
						<table id="taxterritorytable"
							style="overflow-y: scroll; height: 50px;">
							<c:set var="rownumber" scope="session" value="0" />
							<c:forEach var="ShippingList"
								items="${requestScope.ShippingList}">
								<tr>
									<input type="hidden" id="rxaddressID" name="rxaddressID"
										value="<c:out value='${ShippingList.rxAddressID}' />">
									<td><input type="text" name="custFinanceaddr"
										id="custFinanceaddr"
										value="<c:out value='${ShippingList.label}' />"
										readonly="readonly"></td>
									<td><select name="custFinancetaxterr"
										id="custFinancetaxterr" style="width: 180px;"
										onchange="gettaxterritory('<c:out value="${rownumber}" />')">
											<option value="-1">--Select--</option>
											<c:forEach var="AutoCompleteBean"
												items="${requestScope.AutoCompleteBean}">
												<option value="${AutoCompleteBean.id}"
													<c:if test='${AutoCompleteBean.id == ShippingList.id}'>selected="selected" </c:if>>
									...
									<td><label
										id="taxterritoryper<c:out value="${rownumber}" />"
										style="color: red;"><c:out
												value='${ShippingList.value}'></c:out></label></td>
						...
						<tr>
								...
								<fieldset style="width: 450px;"
									...
									<table>
										<tr>
											...
											<td><input type="text" id="customer_paymentTerms"
												value="${requestScope.customerTabFormDataBean.customerTerms}"
												name="paymentTerms" style="width: 200px;" title=""
												placeholder="Minimum 2 characters required"></td>
											<td><img alt="search"
												src="./../resources/scripts/jquery-autocomplete/search.png"></td>
											<td><input type="hidden" id="paymentId"
												value="${requestScope.customerMasterObj.cuTermsId}"
												name="cuPaymentTermsId" style="width: 30px;"></td>
										</tr>
										<tr>
											<td><label><b>Customer Type: </b></label></td>
											<td><select id="customer_customerType"
												name="customerType">
													<option value="-1">- Select -</option>
													<c:forEach var="cuTypeBean"
														items="${requestScope.customerType}">
										...
										<c:if test="${istierPricingEnabled==true}">
											<tr>
										...
										<tr>
											...
											<td><select id="prWarehouseID" name="prWarehouse"
												style="width: 205px;">
													<option value="-1">- Select -</option>
													<c:forEach var="wareHouseBean"
														items="${requestScope.divisionsSearch}">
										...
										<tr>
											...
											<td><input type="text" name="taxExemptNo"
												id="customer_exempt" style="width: 200px"
												value="${requestScope.customerMasterObj.taxExemptNumber}"></td>
										</tr>
										<tr>
											<td><input type="checkbox" name="isPORequired"
												id="PORequired" value="1" onclick="POrequired()"><label>PO
													Required</label></td>
										</tr>
										<tr>
							...
							<td style="vertical-align: top">
								<fieldset class=" ui-widget-content ui-corner-all"
									...
									<table>
										<tr>
											<td><label id="CustomerCategory1label"
												style="display: none;">Sales Rep: </label></td>
											<td>&nbsp;<input type="text" id="customer_salesRepsList"
												name="assignedSalesRep" style="width: 290px; display: none;"
												value="${requestScope.customerTabFormDataBean.assignedSalesRep}"
												title="" placeholder="Minimum 2 characters required"></td>
											<td><img alt="search"
												src="./../resources/scripts/jquery-autocomplete/search.png"
												id="CustomerCategory1image" style="display: none;"></td>
											<td><input type="hidden" id="salesRepId"
												name="assignedSalesRepId"
												value="${requestScope.customerMasterObj.cuAssignmentId0}"
												style="width: 30px;"></td>
										</tr>
										<tr>
											<td><label id="CustomerCategory2label"
												style="display: none;">CSR: </label></td>
											<td>&nbsp;<input type="text" id="customer_CSRList"
												name="assignedCSR" style="width: 290px; display: none;"
												value="${requestScope.customerTabFormDataBean.assignedCSRs}"
												title="" placeholder="Minimum 2 characters required"></td>
											<td><img alt="search"
												src="./../resources/scripts/jquery-autocomplete/search.png"
												id="CustomerCategory2image" style="display: none;"></td>
											<td><input type="hidden" id="CSRId"
												value="${requestScope.customerMasterObj.cuAssignmentId1}"
												name="assignedCSRId" style="width: 30px;"></td>
										</tr>
										<tr>
											<td><label id="CustomerCategory3label"
												style="display: none;">Sales Manager: </label></td>
											<td>&nbsp;<input type="text" id="customer_SalesMgrList"
												name="assignedSalesMgr" style="width: 290px; display: none;"
												value="${requestScope.customerTabFormDataBean.assignedSalesMGRs}"
												title="" placeholder="Minimum 2 characters required"></td>
											<td><img alt="search"
												src="./../resources/scripts/jquery-autocomplete/search.png"
												id="CustomerCategory3image" style="display: none;"></td>
											<td><input type="hidden" id="salesMgrId"
												name="assignedSalesMgrId"
												value="${requestScope.customerMasterObj.cuAssignmentId2}"
												style="width: 30px;"></td>
										</tr>
										<tr>
											<td><label id="CustomerCategory4label"
												style="display: none;">Engineer: </label></td>
											<td>&nbsp;<input type="text" id="customer_EngineersList"
												name="assignedEngineer" style="width: 290px; display: none;"
												value="${requestScope.customerTabFormDataBean.assignedEngineers}"
												title="" placeholder="Minimum 2 characters required"></td>
											<td><img alt="search"
												src="./../resources/scripts/jquery-autocomplete/search.png"
												id="CustomerCategory4image" style="display: none;"></td>
											<td><input type="hidden" id="engineerId"
												name="assignedEngineerId"
												value="${requestScope.customerMasterObj.cuAssignmentId3}"
												style="width: 30px;"></td>
										</tr>
										<tr>
											<td><label id="CustomerCategory5label"
												style="display: none;">Project Manager: </label></td>
											<td>&nbsp;<input type="text" id="customer_PrjMgrList"
												name="assignedPrjMgr" style="width: 290px; display: none;"
												value="${requestScope.customerTabFormDataBean.assignedProjManagers}"
												title="" placeholder="Minimum 2 characters required"></td>
											<td><img alt="search"
												src="./../resources/scripts/jquery-autocomplete/search.png"
												id="CustomerCategory5image" style="display: none;"></td>
											<td><input type="hidden" id="prjMgrId"
												name="assignedPrjMgrId"
												value="${requestScope.customerMasterObj.cuAssignmentId4}"
												style="width: 30px;"></td>
										</tr>
									</table>
								</fieldset>
					...
					<fieldset class="ui-widget-content ui-corner-all"
						...
						<table>
							<tr>
								...
								<td><label id="currentDue">$0.00</label></td>
							</tr>
							<tr>
								<td><label>30 Days:</label></td>
								<td><label id="thirtyDays">$0.00</label></td>
							</tr>
							<tr>
								<td><label>60 Days:</label></td>
								<td><label id="sixtyDays">$0.00</label></td>
							</tr>
							<tr>
								<td><label>90 Days:</label></td>
								<td><label id="nintyDays">$0.00</label></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width: 160px;"><label>Avg. Days to Pay
										Invoice:</label></td>
								<td>0</td>
							</tr>
							<tr>
								<td><label>Since</label>&nbsp;&nbsp;&nbsp;<input
									type="checkbox" id="since" value="" onclick="sinceShowHide()"></td>
								<td><input type="text" class="datepicker"
									name="sinceAppDate" id="sinceDate" value=""
						...
						<tr>
							<td>
								<fieldset class=" ui-widget-content ui-corner-all"
									...
									<table>
										<tr>
											<td><label style="">Credit App:</label> <input
												type="checkbox" name="isCreditApp"
												style="margin-bottom: 0; margin-top: 2px; vertical-align: middle;"
												id="creditApp" onclick="creditAppShowHide()" value="1">
												<input type="text" class="datepicker" name="creditAppDate"
												id="creditDate" style="width: 100px;"></td>
										</tr>
										<tr>
											<td><label>Limit</label>&nbsp; <input type="text"
												style="width: 75px" id="customerCreditLimit" value="">&nbsp;
												<input type="checkbox" name="isCreditHold" id="hold"
												onclick="holdShowHide()"
												style="vertical-align: middle; margin-bottom: 3px;"
												value="1"> <label>Hold</label></td>
										</tr>
										<tr>
											<td id="creditHold"><label>Override Credit Hold
													For Today:</label> <input type="checkbox" name="creditHoldOverride"
												id="creditholdId" value="1" onclick=""></td>
										</tr>
									</table>
								</fieldset>
							</td>
						...
						<tr>
							<td>
								<fieldset class=" ui-widget-content ui-corner-all"
									...
									<table>
										<tr>
											<td><label>YTD:</label></td>
											<td><label id="Year_To_Date">$0.00</label></td>
										</tr>
										<tr>
											<td><label id="thisYear">:</label></td>
											<td><label id="This_Year">$0.00</label></td>
										</tr>
										<tr>
											<td><label>Last Sale:</label></td>
											<td><label id="Last_Sale">$0.00</label></td>
										</tr>
										<tr>
											<td></td>
											<td><label id="Last_Sale_Date"></label></td>
										</tr>
									</table>
								</fieldset>
							</td>
						...
						<tr height="">
							<td style="vertical-align: top">
								<fieldset class=" ui-widget-content ui-corner-all"
									...
									<legend>
										<label><b>Invoicing Method</b></label>
									</legend>
									<table>
										<tr>
											<td>
												<!-- <input type="radio" id="invoiceMethodFaxId" name="invoiceMethod" value="1" onclick="invoiceMethodShowHide()"><label>Fax</label>&nbsp; -->
												<input type="radio" id="invoiceMethodEmailId"
												name="invoiceMethod" value="2"
												onclick="invoiceMethodShowEmailHide()"><label>Email</label>&nbsp;
												<input type="radio" id="invoiceMethodMailId"
												name="invoiceMethod" value="0" checked="checked"
												onclick="invoiceMethodHide()"><label>Mail</label>
											</td>
										</tr>
										<tr>
											<td><label id="invoiceMethodFaxLable">Fax:</label> <label
												id="invoiceMethodEmailLable">Email:</label> <input
												type="text" name="im_text" style="width: 140px;"
												id="invoiceMethodText"></td>
										</tr>
									</table>
								</fieldset>
							</td>
							...
							<td style="vertical-align: top">
								<fieldset class=" ui-widget-content ui-corner-all"
									style="width: 220px; height: 70px;">
									<legend>
										<label><b>Statement Method</b></label>
									</legend>
									<table>
										<tr>
											<td>
												<!-- <input type="radio" id="statementMethodFaxId" name="statementMethod" value="1" onclick="statementMethodShowHide()"><label>Fax</label>&nbsp; -->
												<input type="radio" id="statementMethodEmailId"
												name="statementMethod" value="2"
												onclick="statementMethodShowEmailHide()"><label>Email</label>&nbsp;
												<input type="radio" id="statementMethodMailId"
												name="statementMethod" value="0" checked="checked"
												onclick="statementMethodHide()"><label>Mail</label>
											</td>
										</tr>
										<tr>
											<td><label id="statementMethodFaxLable">Fax:</label> <label
												id="statementMethodEmailLable">Email:</label> <input
												type="text" name="sm_text" style="width: 140px;"
												id="statementMethodText"></td>
										</tr>
									</table>
								</fieldset>
							</td>
		...
		<div id="EmployeeDetails" style="padding-left: 0px;">
			...
			<div id="jobsGridDetailspager" class="scroll"
...
<script type="text/javascript">
	...
	jQuery(document).ready(
			function() {
				...
				$("#currentDue").text(
						formatCurrency("${requestScope.currentDue}"));
				$("#thirtyDays").text(
						formatCurrency("${requestScope.thirtyDays}"));
				$("#sixtyDays").text(
						formatCurrency("${requestScope.sixtyDays}"));
				$("#nintyDays").text(
						formatCurrency("${requestScope.nintyDays}"));
				var total = Number("${requestScope.currentDue}")
						+ Number("${requestScope.thirtyDays}")
						+ Number("${requestScope.sixtyDays}")
						+ Number("${requestScope.nintyDays}");
	...
	function loadcustomercategories() {
		...
		if (Category1labDesc == undefined || Category1labDesc == null
				|| Category1labDesc == "" || Category1labDesc.length == 0) {
			$("#CustomerCategory1label").css({
				display : "none"
			});
			$("#customer_salesRepsList").css({
				display : "none"
			});
			$("#CustomerCategory1image").css({
				display : "none"
			});
		} else {
			$("#CustomerCategory1label").css({
		...
		if (Category2labDesc == undefined || Category2labDesc == null
				|| Category2labDesc == "" || Category2labDesc.length == 0) {
			$("#CustomerCategory2label").css({
				display : "none"
			});
			$("#customer_CSRList").css({
				display : "none"
			});
			$("#CustomerCategory2image").css({
				display : "none"
			});
		} else {
			$("#CustomerCategory2label").css({
		...
		if (Category3labDesc == undefined || Category3labDesc == null
				|| Category3labDesc == "" || Category3labDesc.length == 0) {
			$("#CustomerCategory3label").css({
				display : "none"
			});
			$("#customer_SalesMgrList").css({
				display : "none"
			});
			$("#CustomerCategory3image").css({
				display : "none"
			});
		} else {
			$("#CustomerCategory3label").css({
		...
		if (Category4labDesc == undefined || Category4labDesc == null
				|| Category4labDesc == "" || Category4labDesc.length == 0) {
			$("#CustomerCategory4label").css({
				display : "none"
			});
			$("#customer_EngineersList").css({
				display : "none"
			});
			$("#CustomerCategory4image").css({
				display : "none"
			});
		} else {
			$("#CustomerCategory4label").css({
		...
		if (Category5labDesc == undefined || Category5labDesc == null
				|| Category5labDesc == "" || Category5labDesc.length == 0) {
			$("#CustomerCategory5label").css({
				display : "none"
			});
			$("#customer_PrjMgrList").css({
				display : "none"
			});
			$("#CustomerCategory5image").css({
				display : "none"
			});
		} else {
			$("#CustomerCategory5label").css({
	...
	function parseModelMap() {
		...
		$("#prWarehouseID option[value=" + prWarehouse + "]").attr("selected",
				true);

		var cuType = "${requestScope.customerMasterObj.cuMasterTypeId}";
		$("#customer_customerType option[value=" + cuType + "]").attr(
				"selected", true);
		...
		if (QuoteMethod === "1") {
			...
			$('#quoteMethodText').val(
					"${requestScope.customerMasterObj.qmText}");
		...
		if (invoiceMethod === "1") {
			...
			$('#invoiceMethodText').val(
					"${requestScope.customerMasterObj.imText}");
		...
		if (statementMethod === "1") {
			...
			$('#statementMethodText').val(
					"${requestScope.customerMasterObj.smText}");
			$("input:radio[name='statementMethod']:nth(0)").attr("checked",
					true);
		...
		$("#Last_Sale").text(
				formatCurrency("${requestScope.aCuinvoice.subtotal}"));
		$("#Last_Sale_Date").text(
				customFormatDate("${requestScope.aCuinvoice.invoiceDate}"));
	...
	function CustomerForm_save() {
		...
		if ($("#customer_salesRepsList").val() === "") {
			$("#salesRepId").val("");
		}
		if ($("#customer_CSRList").val() === "") {
			$("#CSRId").val("");
		}
		...
		if ($("#customer_EngineersList").val() === "") {
			$("#engineerId").val("");
		}
		if ($("#customer_PrjMgrList").val() === "") {
			$("#prjMgrId").val("");
		}
		...
		var customerdetails = "rxMasterId=" + rxMasterId + "&"
				+ customerSerialize + "&creditLimit=" + creditLimit;
		$
				.ajax({
					type : "POST",
					...
					success : function(data) {
						...
						jQuery(newDialogDiv)
								.html(
										'<span style="color:Green;"><b>Customer details Updated</b></span>');
					...
					error : function(jqXHR, textStatus, errorThrown) {
						...
						jQuery(newDialogDiv).html(
								'<span style="color:red;"><b>' + errorText
										+ '</b></span>');
						jQuery(newDialogDiv).dialog({
							modal : true,
							width : 500,
			...
			$
					.ajax({
						...
						success : function(data) {
							...
							var percentage = "0.00 %"
							if (data != null) {
								percentage = parseFloat(data.taxRate)
										.toFixed(2)
										+ " %";
	...
	$(function() {
		var cache = {}, lastXhr;
		$("#customer_salesRepsList").autocomplete(
				{
					minLength : 2,
					timeout : 1000,
		...
		$("#customer_CSRList").autocomplete(
				{
					...
					source : function(request, response) {
						...
						lastXhr = $.getJSON("employeeCrud/CSRList", request,
	...
	$(function() {
		var cache = {}, lastXhr;
		$("#customer_SalesMgrList").autocomplete(
				{
					minLength : 2,
					timeout : 1000,
					select : function(event, ui) {
					...
					source : function(request, response) {
						...
						lastXhr = $.getJSON("employeeCrud/salesMGR", request,
								function(data, status, xhr) {
									cache[term] = data;
									if (xhr === lastXhr) {
										response(data);
	...
	$(function() {
		var cache = {}, lastXhr;
		$("#customer_EngineersList").autocomplete(
				{
					minLength : 2,
					timeout : 1000,
					select : function(event, ui) {
					...
					source : function(request, response) {
						...
						lastXhr = $.getJSON("employeeCrud/engineer", request,
								function(data, status, xhr) {
									cache[term] = data;
									if (xhr === lastXhr) {
										response(data);
	...
	$(function() {
		var cache = {}, lastXhr;
		$("#customer_PrjMgrList").autocomplete(
				{
					minLength : 2,
					timeout : 1000,
					select : function(event, ui) {
	...
	$(function() {
		var cache = {}, lastXhr;
		$("#customer_paymentTerms").autocomplete(
				{
					minLength : 2,
					timeout : 1000,
					select : function(event, ui) {
	...
	$(function() {
		var cache = {}, lastXhr;
		$("#customer_customerType").autocomplete(
				{
					minLength : 2,
					timeout : 1000,
					select : function(event, ui) {
					...
					source : function(request, response) {
						...
						lastXhr = $.getJSON("employeeCrud/customerType",
								request, function(data, status, xhr) {
									cache[term] = data;
									if (xhr === lastXhr) {
										response(data);
